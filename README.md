...
To install SFML 2.6.1 we recommend you to install the source code available here https://www.sfml-dev.org/download/sfml/2.6.1/
...
REMARK : you could encounter an error linked to the rpath for step 4. If you use Mac OS, you can fix the error with

    install_name_tool -add_rpath $LIB_DIR/SFML-2.6.1/build/lib ./Catzilla"
